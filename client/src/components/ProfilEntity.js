...
function ProfilEntity() {
  ...
  const internship = useSelector((state) => state.internship?.internshipList);
      ...
      <div className="main-body">
        ...
        <div className="row gutters-sm">
          <div className="col-md-4 mb-3">
            ...
            <div className="card mt-3" style={{ height: "170px" }}>
